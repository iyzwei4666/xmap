...
import com.github.xmap.placesrch.di.component.DaggerPlaceSrchComponent;
import com.github.xmap.placesrch.mvp.contract.PlaceSrchContract;
import com.github.xmap.placesrch.mvp.presenter.PlaceSrchPresenter;
 ...
 * ================================================
 */
public class PlaceSrchActivity extends BaseActivity<PlaceSrchPresenter> implements PlaceSrchContract.View , AMap.OnMarkerClickListener, AMap.InfoWindowAdapter,
        PoiSearch.OnPoiSearchListener, View.OnClickListener {

    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerPlaceSrchComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_place_srch; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
